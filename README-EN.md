...
- This CLI supports customer-side (C-side) APIs for self-operated resource pools (first-class nodes). Business/operations-side (B-side) APIs and joint-operation pools (second-class nodes) are outside its scope. This node classification is distinct from product-specific Type I/II resource-pool versions, such as those in Redis documentation; the numeral alone does not determine whether an API is in scope.
...
| Agent Engine                                                        | `agent-engine`               | `agent-engine`               | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fagent-engine%2F*&label=release)](../../releases)               | `beta`   | `generated` |       11 |         11 |
| AI Capability Platform                                              | `ai-capability`              | `ai-capability`              | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fai-capability%2F*&label=release)](../../releases)              | `beta`   | `generated` |       41 |         41 |
| AI Security                                                         | `ai-security`                | `ai-security`                | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fai-security%2F*&label=release)](../../releases)                | `beta`   | `generated` |        5 |          5 |
| API Gateway                                                         | `api-gateway`                | `api-gateway`                | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fapi-gateway%2F*&label=release)](../../releases)                | `beta`   | `generated` |      161 |        161 |
| Application Performance Monitoring                                  | `apm`                        | `apm`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fapm%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       63 |         63 |
| Application Acceleration                                            | `application-acceleration`   | `application-acceleration`   | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fapplication-acceleration%2F*&label=release)](../../releases)   | `beta`   | `generated` |       12 |         12 |
| Application High Availability                                       | `application-ha`             | `application-ha`             | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fapplication-ha%2F*&label=release)](../../releases)             | `beta`   | `generated` |       43 |         43 |
...
| Billing                                                             | `billing`                    | `billing`                    | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fbilling%2F*&label=release)](../../releases)                    | `beta`   | `generated` |       16 |         16 |
| Cloud Application Engine                                            | `cae`                        | `cae`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fcae%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       44 |         44 |
...
| Cloud Container Engine                                              | `cce`                        | `cce`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fcce%2F*&label=release)](../../releases)                        | `beta`   | `generated` |      306 |        306 |
| CCE One                                                             | `cce-one`                    | `cce-one`                    | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fcce-one%2F*&label=release)](../../releases)                    | `beta`   | `generated` |       41 |         41 |
| Cloud Dedicated Access                                              | `cda`                        | `cda`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fcda%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       61 |         61 |
| Content Delivery Network Acceleration                               | `cdn`                        | `cdn`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fcdn%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       92 |         92 |
...
| Certificate Management Service                                      | `certificate`                | `certificate`                | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fcertificate%2F*&label=release)](../../releases)                | `beta`   | `generated` |       14 |         14 |
...
| ClickHouse                                                          | `clickhouse`                 | `clickhouse`                 | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fclickhouse%2F*&label=release)](../../releases)                 | `beta`   | `generated` |       54 |         54 |
...
| Cloud Audit                                                         | `cloud-audit`                | `cloud-audit`                | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fcloud-audit%2F*&label=release)](../../releases)                | `beta`   | `generated` |       13 |         13 |
| Cloud Native API Gateway                                            | `cloud-native-api-gateway`   | `cloud-native-api-gateway`   | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fcloud-native-api-gateway%2F*&label=release)](../../releases)   | `beta`   | `generated` |      186 |        186 |
| Cloud Search Service                                                | `cloud-search`               | `cloud-search`               | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fcloud-search%2F*&label=release)](../../releases)               | `beta`   | `generated` |        7 |          7 |
| Cloud Monitoring Service                                            | `cm`                         | `cm`                         | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fcm%2F*&label=release)](../../releases)                         | `beta`   | `generated` |      169 |        169 |
...
| Container Registry Service                                          | `crs`                        | `crs`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fcrs%2F*&label=release)](../../releases)                        | `beta`   | `generated` |      269 |        269 |
| Dedicated Cloud (Dedicated Computing)                               | `dec`                        | `dec`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fdec%2F*&label=release)](../../releases)                        | `beta`   | `generated` |        9 |          9 |
| Data Management Service                                             | `dms`                        | `dms`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fdms%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       78 |         78 |
...
| Distributed Relational Database                                     | `drds`                       | `drds`                       | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fdrds%2F*&label=release)](../../releases)                       | `beta`   | `generated` |      125 |        125 |
| Data Transmission Service                                           | `dts`                        | `dts`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fdts%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       72 |         72 |
| Express Connect (Standard Edition)                                  | `ec`                         | `ec`                         | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fec%2F*&label=release)](../../releases)                         | `beta`   | `generated` |       51 |         51 |
| Elastic Container Instances                                         | `eci`                        | `eci`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Feci%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       37 |         37 |
...
| Intelligent Edge Cloud                                              | `ecx`                        | `ecx`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fecx%2F*&label=release)](../../releases)                        | `beta`   | `generated` |      252 |        252 |
| DDoS Protection (Edge Cloud Edition)                                | `edge-ddos`                  | `edge-ddos`                  | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fedge-ddos%2F*&label=release)](../../releases)                  | `beta`   | `generated` |       39 |         39 |
| Edge Security Acceleration Platform                                 | `edge-security-acceleration` | `edge-security-acceleration` | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fedge-security-acceleration%2F*&label=release)](../../releases) | `beta`   | `generated` |       79 |         79 |
| Web Application Firewall (Edge Cloud Edition)                       | `edge-waf`                   | `edge-waf`                   | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fedge-waf%2F*&label=release)](../../releases)                   | `beta`   | `generated` |       68 |         68 |
| Elastic High Performance Computing                                  | `ehpc`                       | `ehpc`                       | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fehpc%2F*&label=release)](../../releases)                       | `beta`   | `generated` |       39 |         39 |
| Elastic IP                                                          | `eip`                        | `eip`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Feip%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       57 |         57 |
| Elastic Load Balancing                                              | `elb`                        | `elb`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Felb%2F*&label=release)](../../releases)                        | `beta`   | `generated` |      114 |        114 |
| MapReduce                                                           | `emr`                        | `emr`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Femr%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       13 |         13 |
...
| Global Traffic Management                                           | `gtm`                        | `gtm`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fgtm%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       21 |         21 |
...
| Distributed Hybrid Transactional and Analytical Processing Database | `htap`                       | `htap`                       | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fhtap%2F*&label=release)](../../releases)                       | `beta`   | `generated` |       47 |         47 |
| Huiju Integrated Intelligent Computing Service Platform             | `huiju`                      | `huiju`                      | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fhuiju%2F*&label=release)](../../releases)                      | `beta`   | `generated` |       86 |         86 |
| Identity and Access Management                                      | `iam`                        | `iam`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fiam%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       87 |         87 |
...
| Influx                                                              | `influxdb`                   | `influxdb`                   | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Finfluxdb%2F*&label=release)](../../releases)                   | `beta`   | `generated` |       48 |         48 |
...
| Kafka                                                               | `kafka`                      | `kafka`                      | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fkafka%2F*&label=release)](../../releases)                      | `beta`   | `generated` |      124 |        124 |
| Key Management                                                      | `kms`                        | `kms`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fkms%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       82 |         82 |
| Live Streaming                                                      | `live-streaming`             | `live-streaming`             | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Flive-streaming%2F*&label=release)](../../releases)             | `beta`   | `generated` |       90 |         90 |
| Log Service                                                         | `lts`                        | `lts`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Flts%2F*&label=release)](../../releases)                        | `beta`   | `generated` |      171 |        171 |
...
| Model Training and Inference                                        | `model-training`             | `model-training`             | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fmodel-training%2F*&label=release)](../../releases)             | `beta`   | `generated` |       67 |         67 |
| Document Database Service                                           | `mongodb`                    | `mongodb`                    | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fmongodb%2F*&label=release)](../../releases)                    | `beta`   | `generated` |      180 |        180 |
| Distributed Message Queuing Telemetry Transport                     | `mqtt`                       | `mqtt`                       | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fmqtt%2F*&label=release)](../../releases)                       | `beta`   | `generated` |       61 |         61 |
| Microservice Cloud Application Platform                             | `msap`                       | `msap`                       | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fmsap%2F*&label=release)](../../releases)                       | `beta`   | `generated` |      157 |        157 |
| Microservice Engine                                                 | `mse`                        | `mse`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fmse%2F*&label=release)](../../releases)                        | `beta`   | `generated` |      243 |        243 |
| NAT Gateway                                                         | `nat`                        | `nat`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fnat%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       22 |         22 |
| Cloud Firewall (Native Edition)                                     | `native-firewall`            | `native-firewall`            | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fnative-firewall%2F*&label=release)](../../releases)            | `beta`   | `generated` |      104 |        104 |
...
| Private DNS                                                         | `private-dns`                | `private-dns`                | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fprivate-dns%2F*&label=release)](../../releases)                | `beta`   | `generated` |       40 |         40 |
| Private NAT Gateway                                                 | `private-nat`                | `private-nat`                | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fprivate-nat%2F*&label=release)](../../releases)                | `beta`   | `generated` |       21 |         21 |
| RabbitMQ                                                            | `rabbitmq`                   | `rabbitmq`                   | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Frabbitmq%2F*&label=release)](../../releases)                   | `beta`   | `generated` |       39 |         39 |
...
| Relational Database for PostgreSQL                                  | `rds-postgresql`             | `rds-postgresql`             | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Frds-postgresql%2F*&label=release)](../../releases)             | `beta`   | `generated` |      156 |        156 |
| SQL Server                                                          | `rds-sqlserver`              | `rds-sqlserver`              | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Frds-sqlserver%2F*&label=release)](../../releases)              | `beta`   | `generated` |      116 |        116 |
| Distributed Cache Service for Redis                                 | `redis`                      | `redis`                      | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fredis%2F*&label=release)](../../releases)                      | `beta`   | `generated` |      207 |        207 |
...
| Research Assistant                                                  | `research-assistant`         | `research-assistant`         | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fresearch-assistant%2F*&label=release)](../../releases)         | `beta`   | `generated` |       46 |         46 |
| RocketMQ                                                            | `rocketmq`                   | `rocketmq`                   | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Frocketmq%2F*&label=release)](../../releases)                   | `beta`   | `generated` |       46 |         46 |
| Resource Orchestration Service                                      | `ros`                        | `ros`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fros%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       40 |         40 |
| SD-WAN                                                              | `sdwan`                      | `sdwan`                      | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fsdwan%2F*&label=release)](../../releases)                      | `beta`   | `generated` |      138 |        138 |
| Server Security (Native Edition)                                    | `server-security`            | `server-security`            | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fserver-security%2F*&label=release)](../../releases)            | `beta`   | `generated` |      154 |        154 |
| Application Service Mesh                                            | `service-mesh`               | `service-mesh`               | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fservice-mesh%2F*&label=release)](../../releases)               | `beta`   | `generated` |       23 |         23 |
...
| Smart Domain Name System                                            | `smart-dns`                  | `smart-dns`                  | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fsmart-dns%2F*&label=release)](../../releases)                  | `beta`   | `generated` |       19 |         19 |
| Cloud Messaging - SMS                                               | `sms`                        | `sms`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fsms%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       24 |         24 |
| Xingchen TokenHub Operations Platform                               | `tokenhub`                   | `tokenhub`                   | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Ftokenhub%2F*&label=release)](../../releases)                   | `beta`   | `generated` |       19 |         19 |
| Shared Traffic Packages                                             | `traffic-package`            | `traffic-package`            | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Ftraffic-package%2F*&label=release)](../../releases)            | `beta`   | `generated` |        6 |          6 |
...
| Intelligent Visual Service                                          | `visual-service`             | `visual-service`             | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fvisual-service%2F*&label=release)](../../releases)             | `beta`   | `generated` |       46 |         46 |
| Video on Demand                                                     | `vod`                        | `vod`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fvod%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       38 |         38 |
| Virtual Private Cloud                                               | `vpc`                        | `vpc`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fvpc%2F*&label=release)](../../releases)                        | `beta`   | `generated` |      207 |        207 |
| VPC Endpoints                                                       | `vpce`                       | `vpce`                       | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fvpce%2F*&label=release)](../../releases)                       | `beta`   | `generated` |       47 |         47 |
| Web Application Firewall (Native Edition)                           | `waf`                        | `waf`                        | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fwaf%2F*&label=release)](../../releases)                        | `beta`   | `generated` |       94 |         94 |
| Whole Site Acceleration                                             | `whole-site-acceleration`    | `whole-site-acceleration`    | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fwhole-site-acceleration%2F*&label=release)](../../releases)    | `beta`   | `generated` |       96 |         96 |
| Yunxiao Intelligent Computing Platform                              | `yunxiao`                    | `yunxiao`                    | [![GitHub Tag](https://img.shields.io/github/v/tag/ArvinZJC/ctyun-cli?filter=releases%2Fplugins%2Fyunxiao%2F*&label=release)](../../releases)                    | `beta`   | `generated` |       88 |         88 |
...
The [product coverage inventory](openapi-catalogs/product-coverage.json) compares promoted commands with the official product catalog, including cross-product references, reviewed equivalent APIs, excluded APIs, and confirmed documentation blockers. Equivalent coverage uses the target product endpoint and response contract; it does not claim support for the older catalog’s response shape.

When using the following plugins, note their scope, configuration requirements, and limitations:

- Gateways: `api-gateway` covers the resource and order proxy catalog for self-operated customer-side usage. `cloud-native-api-gateway` manages standalone cloud-native API gateway instances; gateway commands in `mse` belong to Microservice Engine. These use different endpoints and API contracts.

- Networking: `nat` manages public NAT gateways; `private-nat` manages private NAT gateways. The legacy EIP network query is not yet supported; see the [coverage inventory](openapi-catalogs/eip/coverage.json).
...
- Redis: `redis` is based on the API catalog officially labeled “2023-10-18 II类资源池” (`vid=270`). This Redis catalog label does not mean the joint-operation pools (second-class nodes) excluded by this project. Historical APIs are under `ctyun redis legacy`; it requires core `>=0.5.1 <1.0.0`. All commands include offline response fixtures; the [coverage inventory](openapi-catalogs/redis/coverage.json) records source corrections and remaining waiter gaps.
- MongoDB: older APIs are under `ctyun mongodb v1`; the plugin requires core `>=0.5.1 <1.0.0`. Three export APIs remain unavailable because their binary response contracts are unclear. All supported commands include offline response fixtures; see the [coverage inventory](openapi-catalogs/mongodb/coverage.json).
...
- Cloud Assistant: the API used by `ctyun cloud-assistant command run` is available, but its public API documentation is currently unavailable.
...
go test -timeout=30m ./tools/plugincheck
...
- Generated drafts write `source_fingerprint` from `source.json`; existing plugins retain the version, channel, quality, and core compatibility range from their promoted manifests, raising the minimum to 0.5.0 for waiters or 0.5.1 for request bindings that require independent header, query and body resolution so regeneration cannot downgrade release identity. When the draft passes review and the `generated`/`reviewed`/`curated` quality value truthfully reflects the current curation level, the promote command updates plugin metadata and advances `baseline.json`.
...
- Reuse an output directory containing the current published indexes and plugin archives. When a plugin's archive contents are unchanged, packaging retains its existing compressed bytes and checksum across Go toolchain updates.
...
go run ./tools/release --version 0.5.1 --channel stable --out ./dist/releases --gitee-plugin-download-root "https://gitee.com/ArvinZJC/ctyun-cli/releases/download" --platform "$(go env GOOS)/$(go env GOARCH)"
```
