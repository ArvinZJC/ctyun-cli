	...
	return Catalog{
		...
		Operations: []Operation{
			...
			},
			{
				...
				Parameters: []Parameter{
					{Name: "regionID", Location: "body", Required: true, Type: "string", Profile: "region"},
					{Name: "instanceID", Location: "body", Required: true, Type: "string", Argument: "instance_id"},
				},
				Response: Response{
					SuccessCode: "800",
					ResultPath:  "returnObj",
			...
			},
			{
				...
				DocsURL:     "https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25",
				Retryable:   true,
				Parameters:  []Parameter{{Name: "regionID", Location: "query", Required: true, Type: "string", Argument: "region_id"}},
				Response: Response{
					SuccessCode: "800",
					ResultPath:  "returnObj",
