...
func TestParseParameterValue(t *testing.T) {
	tests := []struct {
		...
		{name: "integer array", valueType: ParameterValueIntegerArray, raw: `[1,9223372036854775808]`, want: []any{json.Number("1"), json.Number("9223372036854775808")}},
		{name: "integer array rejects fraction", valueType: ParameterValueIntegerArray, raw: `[1,1.5]`, wantError: true},
		{name: "integer array rejects string", valueType: ParameterValueIntegerArray, raw: `[1,"2"]`, wantError: true},
