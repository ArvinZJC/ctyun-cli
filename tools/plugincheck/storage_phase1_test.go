...
func TestStoragePhaseOnePluginsMatchCatalogs(t *testing.T) {
	cases := []openAPIPluginExpectation{
		{
			name: "evs", version: "0.1.0-beta.2", displayNameEN: "Elastic Volume Service", productID: 35,
		...
		{
			name: "vbs", version: "0.1.0-beta.2", displayNameEN: "Volume Backup Service", productID: 15,
