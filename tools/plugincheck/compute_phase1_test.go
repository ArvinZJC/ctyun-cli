...
func TestComputePhaseOnePluginsMatchCatalogs(t *testing.T) {
	cases := []openAPIPluginExpectation{
		{name: "acs", version: "0.1.0-beta.2", displayNameEN: "Application Cloud Server", productID: 189, revision: "312", endpoint: "https://ctlite-global.ctapi.ctyun.cn", scope: []string{"/v4/ecs/lite/"}, apiIDs: []string{"23410", "23413", "23411", "23412"}},
