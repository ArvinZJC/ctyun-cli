...
- Added localised command help and table labels, operation-specific request encodings and HTTP response contracts, XML and header-only output, and documentation-derived fixtures with recorded corrections and synthetic examples.
