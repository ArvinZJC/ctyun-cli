...
- Treat generated shell completion scripts, command syntax/examples, raw JSON, CTyun OpenAPI request/response fields, checksums, keys, paths, and other machine-oriented data as data rather than prose; do not translate those values. Translate the surrounding help, status, warning, diagnostic, and error prose that explains them.
